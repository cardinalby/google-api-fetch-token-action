...
Object.defineProperty(exports, "__esModule", { value: true });
exports.WebstoreApi = void 0;
const axios_1 = __importDefault(__webpack_require__(53));
const consts = __importStar(__webpack_require__(748));
const webstoreResource_1 = __webpack_require__(508);
...
exports.WebstoreApi = WebstoreApi;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ItemErrorEntry = void 0;
class ItemErrorEntry {
    constructor(entry) {
...
const webstoreApi = __importStar(__webpack_require__(301));
...
Object.defineProperty(exports, "__esModule", { value: true });
var authApi_1 = __webpack_require__(941);
Object.defineProperty(exports, "fetchToken", { enumerable: true, get: function () { return authApi_1.fetchToken; } });
var consts_1 = __webpack_require__(748);
Object.defineProperty(exports, "PublishTarget", { enumerable: true, get: function () { return consts_1.PublishTarget; } });
Object.defineProperty(exports, "PublishStatus", { enumerable: true, get: function () { return consts_1.PublishStatus; } });
Object.defineProperty(exports, "UploadState", { enumerable: true, get: function () { return consts_1.UploadState; } });
var webstoreApi_1 = __webpack_require__(25);
Object.defineProperty(exports, "WebstoreApi", { enumerable: true, get: function () { return webstoreApi_1.WebstoreApi; } });
var webstoreResource_1 = __webpack_require__(508);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.WebstoreResource = void 0;
const consts_1 = __webpack_require__(748);
const itemErrorEntry_1 = __webpack_require__(176);
class WebstoreResource {
    constructor(resource) {
        ...
        if (Array.isArray(resource.itemError)) {
            this.itemError = resource.itemError.map((entry) => new itemErrorEntry_1.ItemErrorEntry(entry));
        }
    }
    isFailedBecauseOfPendingReview() {
        return (this.uploadState === consts_1.UploadState.FAILURE &&
            this.itemError.length === 1 &&
            this.itemError[0].isPendingReview());
    }
}
exports.WebstoreResource = WebstoreResource;
...
exports.actionInputs = {
    clientId: github_actions_utils_1.actionInputs.getString('clientId', true, true),
    clientSecret: github_actions_utils_1.actionInputs.getString('clientSecret', true, true),
    refreshToken: github_actions_utils_1.actionInputs.getString('refreshToken', true, true),
};
...
(function (DownloadCrx) {
    function getUrl(extensionId, prodVersion, acceptFormat, platform) {
     ...
     */
    let CrxAcceptFormat;
    (function (CrxAcceptFormat) {
        CrxAcceptFormat["CRX2"] = "crx2";
        CrxAcceptFormat["CRX3"] = "crx3";
    })(CrxAcceptFormat = DownloadCrx.CrxAcceptFormat || (DownloadCrx.CrxAcceptFormat = {}));
    /**
     * Probably allowed os
     */
    let PlatformRequestOs;
    (function (PlatformRequestOs) {
        PlatformRequestOs["MAC"] = "mac";
        PlatformRequestOs["WIN"] = "win";
        PlatformRequestOs["ANDROID"] = "android";
        PlatformRequestOs["CROS"] = "cros";
        PlatformRequestOs["OPEN_BSD"] = "openbsd";
        PlatformRequestOs["LINUX"] = "Linux";
    })(PlatformRequestOs = DownloadCrx.PlatformRequestOs || (DownloadCrx.PlatformRequestOs = {}));
    /**
     * Probably allowed architectures
     */
    let PlatformRequestArch;
    (function (PlatformRequestArch) {
        PlatformRequestArch["ARM"] = "arm";
        PlatformRequestArch["X86_64"] = "x86-64";
        PlatformRequestArch["X86_32"] = "x86-32";
    })(PlatformRequestArch = DownloadCrx.PlatformRequestArch || (DownloadCrx.PlatformRequestArch = {}));
    // noinspection JSUnusedGlobalSymbols
    /**
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.PublishStatus = exports.UploadState = exports.urls = exports.PublishTarget = void 0;
const GOOGLE_APIS_URL = 'https://www.googleapis.com';
const ITEMS_API = `chromewebstore/v1.1/items`;
var PublishTarget;
(function (PublishTarget) {
    PublishTarget["DEFAULT"] = "default";
    PublishTarget["TRUSTED_TESTERS"] = "trustedTesters";
...
exports.urls = {
    ...
    publishPost: (id, target) => {
        return (`${GOOGLE_APIS_URL}/${ITEMS_API}/` +
...
(function (UploadState) {
    // noinspection JSUnusedGlobalSymbols
    UploadState["FAILURE"] = "FAILURE";
    UploadState["IN_PROGRESS"] = "IN_PROGRESS";
    UploadState["NOT_FOUND"] = "NOT_FOUND";
...
(function (PublishStatus) {
    // noinspection JSUnusedGlobalSymbols
    PublishStatus["OK"] = "OK";
    PublishStatus["NOT_AUTHORIZED"] = "NOT_AUTHORIZED";
    PublishStatus["INVALID_DEVELOPER"] = "INVALID_DEVELOPER";
    PublishStatus["DEVELOPER_NO_OWNERSHIP"] = "DEVELOPER_NO_OWNERSHIP";
    PublishStatus["DEVELOPER_SUSPENDED"] = "DEVELOPER_SUSPENDED";
    PublishStatus["ITEM_NOT_FOUND"] = "ITEM_NOT_FOUND";
    PublishStatus["ITEM_PENDING_REVIEW"] = "ITEM_PENDING_REVIEW";
    PublishStatus["ITEM_TAKEN_DOWN"] = "ITEM_TAKEN_DOWN";
    PublishStatus["PUBLISHER_SUSPENDED"] = "PUBLISHER_SUSPENDED";
...
exports.actionOutputs = {
    accessToken: new github_actions_utils_1.ActionOutput('accessToken'),
};
